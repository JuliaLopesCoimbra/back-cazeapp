...
def create_event(
    title: str = Form(...),
    event_type: str = Form("carnival"),
    brand_key: str = Form("default"),
    ...
    ticket_url: str = Form(None),  # URL de compra de ingressos
...
def update_event(
    ...
    if ticket_url is not None:
        data["ticket_url"] = ticket_url if ticket_url.strip() else None
