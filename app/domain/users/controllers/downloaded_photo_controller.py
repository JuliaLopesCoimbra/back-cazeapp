...
class DownloadedPhotoController:
    ...
    @staticmethod
    def get_user_downloaded_photos(db, user_id: int, limit: int = 100, offset: int = 0, event_id: int = None) -> List[DownloadedPhotoResponse]:
        return DownloadedPhotoService.get_user_downloaded_photos(db, user_id, limit, offset, event_id)
