...
from app.domain.auth.schemas.auth_schema import RegisterRequest, LoginRequest, TokenResponse, AdminCreateAdminRequest, \
    InviteAdminRequest, FirstAccessRequest, ResendAdminInviteRequest, InviteSubadminRequest, InviteColunistaRequest, UserResponse, UserDetailResponse, UserActivityItem, AgeVerificationRequest, CompleteProfileRequest, CompleteEmailRequest, CompleteEmailResponse, UpdateEmailByCpfRequest, UpdateEmailByCpfResponse
...
def list_subadmins(
    ...
    status: str = Query(None, description="Filtro de status: active | inactive"),
    ...
    return AuthController.list_subadmins(db, requester, search, status, limit, offset)
...
def list_colunistas(
    ...
    return AuthController.list_colunistas(db, requester, search, status, limit, offset)
...
def list_users(
    ...
    return AuthController.list_users(db, requester, search, status, limit, offset)
...
def get_user_detail(
    ...
    return AuthController.get_user_detail(db, requester, user_id)
...
def resend_invite(
    ...
    return AuthController.resend_invite(db, user_id, requester)
...
def get_user_activity(
    ...
    return AuthController.get_user_activity(db, interaction_db, admin_db, user_id, requester, limit, offset)
