...
async def search_face(
    ...
    body = SearchFaceRequest(threshold=threshold, max_faces=max_faces, collection_id=collection_id)
...
def download_image(
    ...
    try:
        ...
        DownloadedPhotoController.create_downloaded_photo(interaction_db, current_user.id, create_request)
