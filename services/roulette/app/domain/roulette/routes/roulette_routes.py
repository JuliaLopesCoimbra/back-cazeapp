...
from app.domain.roulette.schemas.roulette_schema import RouletteResponseSchema
...
def create_roulette(
    ...
    roulette_image_url = upload_image_to_s3(roulette_image, "roulette_photos") if roulette_image else None
    pointer_image_url = upload_image_to_s3(pointer_image, "pointer_photos") if pointer_image else None
